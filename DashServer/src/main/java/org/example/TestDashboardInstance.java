...
import org.example.testopmode.TestOpModeManager;
...
public class TestDashboardInstance {
    ...
    ReceiveGamepadState.Gamepad gamepad1;
        ...
        protected void onMessage(NanoWSD.WebSocketFrame message) {
            ...
            switch (msg.getType()) {
                ...
                case RECEIVE_GAMEPAD_STATE:
                    gamepad1 = ((ReceiveGamepadState) msg).getGamepad1();
                    gamepad2 = ((ReceiveGamepadState) msg).getGamepad2();
                    break;
                default:
